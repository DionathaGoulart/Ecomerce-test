...
export function SplineBackground() {
  return (
    <div className="hidden md:block spline-background sticky top-0 w-full z-0 pointer-events-none m-0 p-0 h-[calc(100vh-50px)]" style={{ clipPath: 'inset(0 0 50px 0)', zIndex: 0 }}>
